    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 clearfix">
                ...
                if (isset($_SESSION['outOfStrok']) || !empty($_SESSION['outOfStrok'])) { ?>
                    <div class="alert <?= !empty($_SESSION['outOfStrok']) ? 'alert-danger' : '' ?> ">
                        <?php 
                        
                        echo $_SESSION['outOfStrok']; 
                        unset($_SESSION['outOfStrok']);
                ...
                if (isset($_COOKIE['user_cart'])) {
                    ...
                    if (count($result) > 0) { ?>
                        ...
                        <?php if (isset($_SESSION['user_role'])) { ?>
                            ...
                            <form action="proceed_to_checkout.php" class="checkout-form pull-right" method="POST">
                                <?php
                                $product_id = '';
                                ...
                                <input type="submit" class="btn btn-md btn-success" value="Proceed to Checkout" id="proceedToChechout">
                            </form>
                        <?php } else { ?>
