            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-3" id="admin-menu">
                    <ul class="menu-list">
                        ...
                        <?php
                        $db->select("order_products", "*", null, "delivery = 0");
                        $res = $db->getResult();
                        
                        $_SESSION['count'] = count($res);
                        ?>
                        <li <?php if (basename($_SERVER['PHP_SELF']) == "orders.php") echo 'class="active"'; ?>><a href="orders.php">Orders <span class="badge notification-count"><?= isset($_SESSION['count']) && $_SESSION['count'] > 0 ? $_SESSION['count'] : ''; ?></span></a></li>
