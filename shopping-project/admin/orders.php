                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                    ...
                                    // $db->select('products', 'qty', null, "product_id = '$product_code[$p]'");
                                    // $res = $db->getResult();
                                    // if(!empty($res)){
                                    //     $cal = $res[0]['qty'] - $product_qty[$p];

                                    //     $db->update('products',['qty'=>$cal], "product_id = '$product_code[$p]'");
                                    // }
                            ...
                            <td>
                                ...
                                <b>Mobile : </b><?php echo $row[$i]['mobile']; ?><br>
                            </td>
                            ...
                            <td>
                                ...
                                <?php } elseif ($row[$i]['delivery'] == '2') { ?>
                                    <span class="label label-danger">Cancelled</span>
                                <?php } else { ?>
                                    <a class="btn btn-sm btn-primary order_complete" href="" data-id="<?php echo $row[$i]['order_id']; ?>">complete</a>
                                    <a class="btn btn-sm btn-danger order_cancle" href="" data-id="<?php echo $row[$i]['order_id']; ?>">cancel</a>
                                <?php } ?>
                            </td>
                        </tr>
                <?php }
