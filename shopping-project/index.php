        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="popular-carousel owl-carousel owl-theme">
                    <?php
                    $db->select('products', '*', null, 'product_views > 0 AND product_status = 1', 'product_views DESC', 10);
                    $result = $db->getResult();
                    if (count($result) > 0) {
                        foreach ($result as $row) {

                            $_SESSION['addCatProID'] = $row['product_id'];
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="latest-carousel owl-carousel owl-theme">
                    <?php
                    $db = new Database();
                    $db->select('products', '*', null,'product_status = 1', 'product_id DESC', 6);
                    $result = $db->getResult();
                    if (count($result) > 0) {
                        foreach ($result as $row) { ?>
                            <div class="product-grid latest item">
