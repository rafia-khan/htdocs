                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                                ...
                                if (isset($_SESSION["user_role"])) {
                                    $db->select("order_products", "*", null, "product_user = " . $_SESSION['user_id'] . " AND (delivery = 1 OR delivery = 2 )AND ntfcount = 0");
                                    $res = $db->getResult();
                                    $count = count($res);

                                ?>
                                    Hello <?php echo $_SESSION["username"]; ?><i class="caret"></i>
                                    <div id="<?= $count > 0 ? 'top-notification-count' : ''; ?>"></div>
                                <?php  } else { ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                    ...
                                    <li><a href="user_orders.php" class="" id="ntfcount">My Orders <div id="<?= $count > 0 ? 'notification-count' : ''; ?>"></div></a> </li>
                ...
                <div class="col-md-12">
                    <nav id="main_menu">
                        <div class="inner_menu">
                            <ul>
                                <li><a href="index.php" id="home1">HOMEPAGE</a></li>
                                <?php
                                $db = new Database();
